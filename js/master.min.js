...
function PageViewModel(c){var a=this;a.storage=c;a.date=ko.observable();a.dateError=ko.observable(!1);a.amount=ko.observable();a.amountError=ko.observable(!1);a.timeAmount=ko.observable(c.getTimeAmount()||2);a.lastTimeAmount=1;a.timeUnit=ko.observable(c.getTimeUnit()||"Years");a.rows=ko.observableArray();a.isSmall=ko.observable(!1);a.daysLeft=ko.observable(0);a.nextRow=null;a.loading=!1;a.timeUnitOptions=["Days","Months","Years"];a.sizeRow=new RowViewModel(new Date(0),new Currency("0"),!1,a.isSmall,
"SizeRow");a.todayRow=new RowViewModel(new Date,new Currency("0"),!1,a.isSmall,"Today");a.rows.push(a.todayRow);a.timeAmountOptions=ko.computed(function(){var a=this.timeUnit(),d=this.timeAmount.peek(),c=0;switch(a){case "Days":c=30;break;case "Months":c=12;break;case "Years":c=20;break;default:console.error("Failed to populate time amounts from unit: "+this.timeUnit());return}d>c&&(d=c);console.log("amount",d);this.timeAmount(d);a=[];for(d=1;d<=c;d++)a.push(d);return a},this);a.removePair=function(b){a.rows.remove(b);
a.rows.remove(b.matchingRow)};a.rows.subscribe(function(b){var d=new Currency("0");b.forEach(function(a){a.update(d)});a.loading||a.storage.setDates(b);b=a.rows.indexOf(a.todayRow);if(-1!==b&&b<a.rows().length-1){a.nextRow=a.rows()[b+1];b=util.stripTime(a.nextRow.date);var c=util.stripTime(a.todayRow.date);b=(b-c)/864E5;c=Math.floor(b);if(c!==b){var f=Math.ceil(b);b=f-b<b-c?f:c}a.daysLeft(b)}});a.updateDuration=function(){var b=[];a.rows().forEach(function(a){a.isStart&&b.push({date:a.date,amount:a.amount})});
a.deleteAll();b.forEach(function(b){a.addDate(b.date,b.amount)})};a.timeAmount.subscribe(a.updateDuration);a.timeUnit.subscribe(a.updateDuration);a.deleteAll=function(){a.rows.remove(function(a){return!a.isToday})};a.getInput=function(){var b=new Date(a.date()),c=new Currency(a.amount()),e=!0;c.valid||(e=!1);a.amountError(!c.valid);util.isInvalidDate(b)?(e=!1,a.dateError(!0)):a.dateError(!1);e&&(a.date(""),a.amount(""),a.addDate(b,c));return!1};a.timeAmount.subscribe(function(b){console.log("saving timeAmount "+
b);a.storage.setTimeAmount(b)});a.timeUnit.subscribe(function(b){a.storage.setTimeUnit(b)})}
