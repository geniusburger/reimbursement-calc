...
function PageViewModel(e){var a=this;a.storage=e;a.date=ko.observable();a.dateError=ko.observable(!1);a.amount=ko.observable();a.amountError=ko.observable(!1);a.timeAmount=ko.observable(e.getTimeAmount()||2);a.lastTimeAmount=1;a.timeUnit=ko.observable(e.getTimeUnit()||"Years");a.rows=ko.observableArray();a.isSmall=ko.observable(!1);a.daysLeft=ko.observable(0);a.dateFocus=ko.observable(!0);a.amountFocus=ko.observable(!1);a.nextRow=null;a.loading=!1;a.timeUnitOptions=["Days","Months","Years"];a.sizeRow=
new RowViewModel(new Date(0),new Currency("0"),!1,a.isSmall,"SizeRow");a.todayRow=new RowViewModel(new Date,new Currency("0"),!1,a.isSmall,"Today");a.rows.push(a.todayRow);a.timeAmountOptions=ko.computed(function(){var a=this.timeUnit(),c=this.timeAmount.peek(),d=0;switch(a){case "Days":d=30;break;case "Months":d=12;break;case "Years":d=20;break;default:console.error("Failed to populate time amounts from unit: "+this.timeUnit());return}c>d&&(c=d);this.timeAmount(c);a=[];for(c=1;c<=d;c++)a.push(c);
return a},this);a.removePair=function(b){a.rows.remove(b);a.rows.remove(b.matchingRow)};a.rows.subscribe(function(b){var c=new Currency("0");b.forEach(function(a){a.update(c)});a.loading||a.storage.setDates(b);b=a.rows.indexOf(a.todayRow);if(-1!==b&&b<a.rows().length-1){a.nextRow=a.rows()[b+1];b=util.stripTime(a.nextRow.date);var d=util.stripTime(a.todayRow.date);b=(b-d)/864E5;d=Math.floor(b);if(d!==b){var e=Math.ceil(b);b=e-b<b-d?e:d}a.daysLeft(b)}});a.updateDuration=function(){var b=[];a.rows().forEach(function(a){a.isStart&&
b.push({date:a.date,amount:a.amount})});a.deleteAll();b.forEach(function(b){a.addDate(b.date,b.amount)})};a.timeAmount.subscribe(a.updateDuration);a.timeUnit.subscribe(a.updateDuration);a.deleteAll=function(){a.rows.remove(function(a){return!a.isToday})};a.getInput=function(){var b=new Date(a.date()),c=new Currency(a.amount()),d=!0;c.valid||(d=!1,a.amountFocus(!0));a.amountError(!c.valid);util.isInvalidDate(b)?(d=!1,a.dateError(!0),a.dateFocus(!0)):a.dateError(!1);d&&(a.date(""),a.amount(""),a.addDate(b,
