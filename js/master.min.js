...
StorageManager.prototype.setTimeUnit=function(a){this.set(this.names.TIME_UNIT,a)};StorageManager.prototype.getTimeAmount=function(){return this.get(this.names.TIME_AMOUNT)};StorageManager.prototype.setTimeAmount=function(a){this.set(this.names.TIME_AMOUNT,a)};StorageManager.prototype.getDates=function(){var a=this.get(this.names.DATES),b=[];null!==a&&""!==a&&a.split(":").forEach(function(a){var c=a.split("@");2===c.length?b.push(c):console.warn("invalid saved date value",a)});return b};
StorageManager.prototype.setDates=function(a){var b="";"undefined"===typeof a&&(a=dateRowUtil.getStartRows());a.filter(function(a){return a.isStart}).forEach(function(a,c){c&&(b+=":");b+=a.amount.toString()+"@"+a.date.toDateString()});this.set(this.names.DATES,b)};StorageManager.prototype.getCookie=function(a){a+="=";for(var b=document.cookie.split(";"),d=0;d<b.length;d++){var c=b[d].trim();if(0==c.indexOf(a))return c.substring(a.length,c.length)}return null};
...
function PageViewModel(e){var a=this;a.storage=e;a.date=ko.observable();a.dateError=ko.observable(!1);a.amount=ko.observable();a.amountError=ko.observable(!1);a.timeAmount=ko.observable(e.getTimeAmount()||2);a.lastTimeAmount=1;a.timeUnit=ko.observable(e.getTimeUnit()||"Years");a.rows=ko.observableArray();a.isSmall=ko.observable(!1);a.daysLeft=ko.observable(0);a.nextRow=null;a.loading=!1;a.timeUnitOptions=["Days","Months","Years"];a.sizeRow=new RowViewModel(new Date(0),new Currency("0"),!1,a.isSmall,
"SizeRow");a.todayRow=new RowViewModel(new Date,new Currency("0"),!1,a.isSmall,"Today");a.rows.push(a.todayRow);a.timeAmountOptions=ko.computed(function(){var a=this.timeUnit(),c=this.timeAmount.peek(),d=0;switch(a){case "Days":d=30;break;case "Months":d=12;break;case "Years":d=20;break;default:console.error("Failed to populate time amounts from unit: "+this.timeUnit());return}c>d&&(c=d);this.timeAmount(c);a=[];for(c=1;c<=d;c++)a.push(c);return a},this);a.removePair=function(b){a.rows.remove(b);a.rows.remove(b.matchingRow)};
a.rows.subscribe(function(b){var c=new Currency("0");b.forEach(function(a){a.update(c)});a.loading||a.storage.setDates(b);b=a.rows.indexOf(a.todayRow);if(-1!==b&&b<a.rows().length-1){a.nextRow=a.rows()[b+1];b=util.stripTime(a.nextRow.date);var d=util.stripTime(a.todayRow.date);b=(b-d)/864E5;d=Math.floor(b);if(d!==b){var e=Math.ceil(b);b=e-b<b-d?e:d}a.daysLeft(b)}});a.updateDuration=function(){var b=[];a.rows().forEach(function(a){a.isStart&&b.push({date:a.date,amount:a.amount})});a.deleteAll();b.forEach(function(b){a.addDate(b.date,
b.amount)})};a.timeAmount.subscribe(a.updateDuration);a.timeUnit.subscribe(a.updateDuration);a.deleteAll=function(){a.rows.remove(function(a){return!a.isToday})};a.getInput=function(){var b=new Date(a.date()),c=new Currency(a.amount()),d=!0;c.valid||(d=!1);a.amountError(!c.valid);util.isInvalidDate(b)?(d=!1,a.dateError(!0)):a.dateError(!1);d&&(a.date(""),a.amount(""),a.addDate(b,c));return!1};a.timeAmount.subscribe(function(b){a.storage.setTimeAmount(b)});a.timeUnit.subscribe(function(b){a.storage.setTimeUnit(b)});
a.rowMouseOver=function(b){a.highlight(b,!0)};a.rowMouseOut=function(b){a.highlight(b,!1)};a.nextMouseOver=function(){a.highlight(a.nextRow,!0)};a.nextMouseOut=function(){a.highlight(a.nextRow,!1)};a.highlight=function(a,c){a.isToday||a.isSizeRow||a.isHighlighted(c).matchingRow.isHighlighted(c)}}
PageViewModel.prototype.addDate=function(e,a){var b=new Date(e),c=Number(this.timeAmount());switch(this.timeUnit()){case "Days":b.setDate(b.getDate()+c);break;case "Months":b.setMonth(b.getMonth()+c);break;default:console.log("Failed to find time unit, defaulting to years");case "Years":b.setFullYear(b.getFullYear()+c)}c=new RowViewModel(e,a,!0,this.isSmall);b=new RowViewModel(b,new Currency(a),!1,this.isSmall);c.matchingRow=b;b.matchingRow=c;this.rows.push(c);this.rows.push(b);this.rows.sort(function(a,
b){return a.date.getTime()-b.date.getTime()})};PageViewModel.prototype.loadTestData=function(){[["$7802.05","7/6/2012"],["$6931.49","2/1/2013"],["$7568.49","4/12/2013"],["$3802.00","1/6/2012"],["$3658.51","4/13/2012"],["$775.00","12/21/2012"],["$4350.00","6/28/2013"]].forEach(function(e){this.addDate(new Date(e[1]),new Currency(e[0]))},this)};
PageViewModel.prototype.loadSavedData=function(){this.loading=!0;this.storage.getDates().forEach(function(e){this.addDate(new Date(e[1]),new Currency(e[0]))},this);this.loading=!1};

var rc={DARK:"#272b30",MID:"#2e3338",LIGHT:"#49515a",LINE:"#3366cc",TEXT:"#c8c8c8"};rc.BACKGROUND=rc.DARK;rc.GRID=rc.LIGHT;
rc.CHART_OPTIONS={pointSize:6,backgroundColor:rc.BACKGROUND,selectionMode:"multiple",animation:{duration:300},series:{color:rc.LINE},tooltip:{textStyle:{color:rc.TEXT}},hAxis:{titleTextStyle:{color:rc.TEXT},textStyle:{color:rc.TEXT},baselineColor:rc.GRID,gridlines:{color:"transparent"}},vAxis:{format:"$#,###",titleTextStyle:{color:rc.TEXT},textStyle:{color:rc.TEXT},baselineColor:rc.GRID,gridlines:{color:rc.GRID}},legend:{position:"none"}};rc.storage=void 0;rc.chart=void 0;rc.wasSmall=!1;
...
rc.buildDot=function(a,b){var c=a.dateCell.date,d=c.toString().split(" ")[1]+" "+c.getDate()+", "+c.getFullYear();b=b||a.owedCell.currency.toFloat();return[{v:c,f:d},{v:b,f:a.owedCell.currency.toString()}]};rc.setSmall=function(a){return a!==rc.wasSmall?(rc.viewModel.isSmall(a),rc.wasSmall=a,!0):!1};rc.checkOverflow=function(){var a=rc.$column.width();rc.lastColWidth!==a&&(rc.lastColWidth=a,rc.largeTableWidth||(rc.largeTableWidth=rc.$table.width()),rc.viewModel.isSmall(rc.largeTableWidth>a))};
