...
function RowViewModel(b,c,d,e,f){this.owed=ko.observable(new Currency("0"));this.isHighlighted=ko.observable(!1);this.date=b;this.amount=c;this.isStart=d;this.isToday=f;this.isSmall=e;this.matchingRow=null;this.formattedDate=ko.pureComputed(function(){var a=this.isSmall();return this.isToday?"Today":a?this.date.toLocaleDateString():this.date.toDateString()},this);this.formattedAmount=ko.pureComputed(function(){var a=this.amount.toString(),b=this.isSmall();if(this.isToday)return"";b&&(a=a.substring(0,
a.lastIndexOf(".")));return a},this);this.formattedOwed=ko.pureComputed(function(){var a=this.owed().toString();this.isSmall()&&(a=a.substring(0,a.lastIndexOf(".")));return a},this);this.formattedType=ko.pureComputed(function(){var a=this.isSmall();return this.isToday?"":this.isStart?a?"+":"Reimbursed":a?"-":"Expired"},this)}RowViewModel.prototype.update=function(b){b.adjust(this.amount);this.owed(new Currency(b))};
function PageViewModel(){var a=this;a.date=ko.observable();a.amount=ko.observable();a.timeAmount=ko.observable(2);a.timeUnit=ko.observable("Years");a.rows=ko.observableArray();a.isSmall=ko.observable(!1);a.timeAmountOptions=ko.observableArray();a.timeUnitOptions=["Days","Months","Years"];a.populateTimeAmounts();a.removePair=function(c){a.rows.remove(c);a.rows.remove(c.matchingRow)};a.rows.subscribe(function(a){var b=new Currency("0");a.forEach(function(a,c,e){console.log("updating row "+c+" of "+
e.length+" with owed "+b.toString()+", before: "+a.owed());a.update(b);console.log("updating row "+c+" of "+e.length+" with owed "+b.toString()+", after:  "+a.owed())})});a.deleteAll=function(){a.rows.removeAll();a.rows.push(new RowViewModel(new Date,new Currency("0"),!0,a.isSmall,!0))};a.rows.push(new RowViewModel(new Date,new Currency("0"),!0,a.isSmall,!0))}
...
PageViewModel.prototype.addDate=function(a,c){var b=new Date(a),d=Number(this.timeAmount());switch(this.timeUnit()){case "Days":b.setDate(b.getDate()+d);break;case "Months":b.setMonth(b.getMonth()+d);break;default:console.log("Failed to find time unit, defaulting to years");case "Years":b.setFullYear(b.getFullYear()+d)}d=new RowViewModel(a,c,!0,this.isSmall);b=new RowViewModel(b,new Currency(c),!1,this.isSmall);d.matchingRow=b;b.matchingRow=d;this.rows.push(d);this.rows.push(b);this.rows.sort(function(a,
b){return a.date.getTime()-b.date.getTime()})};PageViewModel.prototype.loadTestData=function(){[["$7802.05","7/6/2012"],["$6931.49","2/1/2013"],["$7568.49","4/12/2013"],["$3802.00","1/6/2012"],["$3658.51","4/13/2012"],["$775.00","12/21/2012"],["$4350.00","6/28/2013"]].forEach(function(a){this.addDate(new Date(a[1]),new Currency(a[0]))},this)};PageViewModel.prototype.rowMouseOver=function(a){a.isToday||a.isHighlighted(!0).matchingRow.isHighlighted(!0)};
PageViewModel.prototype.rowMouseOut=function(a){a.isToday||a.isHighlighted(!1).matchingRow.isHighlighted(!1)};
