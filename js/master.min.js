...
ko.bindingHandlers.enterkey={init:function(b,f,d,c){var e=d();$(b).on("keypress","input, textarea, select",function(a){if(13!==(a.which||a.keyCode))return!0;a=a.target;a.blur();e.enterkey.call(c,c,a,b);return!1})}};
...
function PageViewModel(c,f){var a=this;a.storage=c;a.highlightPoints=f;a.updateChart=null;a.date=ko.observable();a.dateError=ko.observable(!1);a.amount=ko.observable();a.amountError=ko.observable(!1);a.timeAmount=ko.observable(c.getTimeAmount()||2);a.lastTimeAmount=1;a.timeUnit=ko.observable(c.getTimeUnit()||"Years");a.rows=ko.observableArray();a.isSmall=ko.observable(!1);a.daysLeft=ko.observable(0);a.dateFocus=ko.observable(!0);a.amountFocus=ko.observable(!1);a.nextRow=null;a.loading=!1;a.timeUnitOptions=
...
2&&a.updateChart&&a.updateChart()});a.updateDuration=function(){var b=[];a.rows().forEach(function(a){a.isStart&&b.push({date:a.date,amount:a.amount})});a.deleteAll();b.forEach(function(b){a.addDate(b.date,b.amount,!0)});a.rows.valueHasMutated()};a.timeAmount.subscribe(a.updateDuration);a.timeUnit.subscribe(a.updateDuration);a.deleteAll=function(){a.rows.remove(function(a){return!a.isToday})};a.getInput=function(){var b=new Date(a.date()),c=new Currency(a.amount()),d=!0;c.valid||(d=!1,a.amountFocus(!0));
a.amountError(!c.valid);util.isInvalidDate(b)?(d=!1,a.dateError(!0),a.dateFocus(!0)):a.dateError(!1);d&&(a.date(""),a.amount(""),a.addDate(b,c),a.highlightPoints(),a.dateFocus(!0));return!1};a.timeAmount.subscribe(function(b){a.storage.setTimeAmount(b)});a.timeUnit.subscribe(function(b){a.storage.setTimeUnit(b)});a.rowMouseOver=function(b){a.unHighlightAllRows();a.highlight(b)&&a.highlightPoints(b)};a.mouseOut=function(){a.unHighlightAllRows();a.highlightPoints()};a.nextMouseOver=function(){a.unHighlightAllRows();
a.highlight(a.nextRow)&&a.highlightPoints(a.nextRow)};a.highlight=function(a){return a.isToday||a.isSizeRow?!1:(a.isHighlighted(!0).matchingRow.isHighlighted(!0),!0)};a.unHighlightAllRows=function(){a.rows().forEach(function(a){a.isHighlighted(!1)})}}
...
b){return a.date.getTime()-b.date.getTime()});a||this.rows.valueHasMutated()};PageViewModel.prototype.loadTestData=function(){[["$7802.05","7/6/2012"],["$6931.49","2/1/2013"],["$7568.49","4/12/2013"],["$3802.00","1/6/2012"],["$3658.51","4/13/2012"],["$775.00","12/21/2012"],["$4350.00","6/28/2013"]].forEach(function(c){this.addDate(new Date(c[1]),new Currency(c[0]),!0)},this);this.rows.valueHasMutated();this.highlightPoints()};
PageViewModel.prototype.loadSavedData=function(){this.loading=!0;this.storage.getDates().forEach(function(c){this.addDate(new Date(c[1]),new Currency(c[0]),!0)},this);this.rows.valueHasMutated();this.loading=!1};PageViewModel.prototype.getStartRows=function(){return this.rows().filter(function(c){return c.isStart})};

var rc={DARK:"#272b30",MID:"#2e3338",LIGHT:"#49515a",LINE:"#3366cc",TEXT:"#c8c8c8"};rc.BACKGROUND=rc.DARK;rc.GRID=rc.LIGHT;
rc.CHART_OPTIONS={pointSize:6,backgroundColor:rc.BACKGROUND,selectionMode:"multiple",animation:{duration:300,easing:"inAndOut"},series:{color:rc.LINE},tooltip:{textStyle:{color:rc.TEXT}},hAxis:{titleTextStyle:{color:rc.TEXT},textStyle:{color:rc.TEXT},baselineColor:rc.GRID,gridlines:{color:"transparent"}},vAxis:{format:"$#,###",titleTextStyle:{color:rc.TEXT},textStyle:{color:rc.TEXT},baselineColor:rc.GRID,gridlines:{color:rc.GRID}},legend:{position:"none"}};rc.storage=void 0;rc.chart=void 0;
rc.completeLoadDate=function(){rc.drawChart();setTimeout(function(){rc.highlightPoints();rc.viewModel.updateChart=rc.drawChart},1E3)};rc.hoverPointHandler=function(a){rc.lastPoint=a;var b=rc.viewModel.rows.indexOf(rc.viewModel.todayRow);a.row===b?rc.setChartSelection([{row:b,column:1}],rc.colorPoints):(a=rc.viewModel.rows()[a.row],rc.viewModel.highlight(a,!0),rc.highlightPoints(a))};rc.unhoverPointHandler=function(){rc.viewModel.unHighlightAllRows();rc.setChartSelection();rc.highlightPoints()};
rc.selectPointHandler=function(){rc.hoverPointHandler(rc.lastPoint)};rc.highlightPoints=function(a){var b=rc.viewModel.todayRow,c=rc.viewModel.rows.indexOf(b);if("undefined"===typeof a||null===a)a=[{row:c,column:1}];else{var d=a.isStart?a:a.matchingRow,e=d.matchingRow,f=rc.viewModel.rows.indexOf(d),g=rc.viewModel.rows.indexOf(e);a=[{row:f,column:1},{row:g,column:1},{row:c,column:1}]}rc.setChartSelection(a,function(){rc.colorPoints(d,e,b,f,g,c)})};
rc.colorPoints=function(a,b,c,d,e,f){rc.TODAY_COLOR||(rc.TODAY_COLOR=rc.$table.find(".active").children("td").first().css("backgroundColor"));a=$("svg>g>g>g>circle");b=[];for(c=0;c<a.length;c++)b.push(a[c].outerHTML);var g=1,k=2,h=3;b=4;c=5;6>a.length?rc.setSelectedPointColor(a[0],a[a.length-1],rc.TODAY_COLOR):(6<a.length&&("none"==a[2].getAttribute("fill")?(g+=3,k+=3,h+=3,b+=3,c+=3):"none"==a[4].getAttribute("fill")?(h+=3,b+=3,c+=3):"none"==a[6].getAttribute("fill")&&(c+=3)),f<d?(e=0,d=k,f=h,k=b,
h=c):f<e?(d=0,f=g,e=k,g=h,k=b,h=c):(d=0,f=g,e=b,g=c),rc.START_COLOR||(rc.START_COLOR=rc.$table.find("tr.start.highlight").first().css("backgroundColor")),rc.STOP_COLOR||(rc.STOP_COLOR=rc.$table.find("tr.stop.highlight").first().css("backgroundColor")),rc.setSelectedPointColor(a[d],a[f],rc.START_COLOR),rc.setSelectedPointColor(a[k],a[h],rc.STOP_COLOR),rc.setSelectedPointColor(a[e],a[g],rc.TODAY_COLOR))};rc.SELECT_RETRY_LIMIT=10;rc.callbackHandles=[];
rc.setChartSelection=function(a,b,c){try{rc.lastChartSelectionCallback=b,rc.chart.setSelection(a),b&&b()}catch(d){console.warn("Oddity setting selection, waiting for animation to finish",d),rc.lastChartSelectionCallback=function(){rc.chart.setSelection(a);b&&b()}}};rc.setSelectedPointColor=function(a,b,c){$(a).attr("stroke",c);$(b).attr("fill",c)};
rc.chartAnimationFinish=function(){console.log("animationFinish");rc.lastChartSelectionCallback&&rc.lastChartSelectionCallback();rc.lastChartSelectionCallback=null};
rc.drawChart=function(){if(chartIsReady){rc.chart||(rc.chart=new google.visualization.LineChart(document.getElementById("chart")),google.visualization.events.addListener(rc.chart,"select",rc.selectPointHandler),google.visualization.events.addListener(rc.chart,"onmouseover",rc.hoverPointHandler),google.visualization.events.addListener(rc.chart,"onmouseout",rc.unhoverPointHandler),google.visualization.events.addListener(rc.chart,"animationfinish",rc.chartAnimationFinish));var a=rc.viewModel.rows();
1>=a.length?rc.$chart.css("visibility","hidden"):rc.$chart.css("visibility","visible");for(var b=null,c=null,d=[["Date","Owed"]],e=0;e<a.length;e++)if(a[e].isToday)c=a[e];else{if(c){if(b)var f=a[e],g=b.date.getTime(),k=c.date.getTime(),h=f.date.getTime()-g,g=(k-g)/h,b=b.owed().toFloat(),f=f.owed().toFloat(),f=b+g*(f-b);else f=0;d.push(rc.buildDot(c,f));c=null}b=a[e];d.push(rc.buildDot(b))}c&&d.push(rc.buildDot(c));rc.chart.draw(google.visualization.arrayToDataTable(d),rc.CHART_OPTIONS)}else rc.$chart.css("visibility",
"hidden"),console.error("Chart not ready")};rc.buildDot=function(a,b){var c=a.date,d=c.toString().split(" ")[1]+" "+c.getDate()+", "+c.getFullYear();b=b||a.owed().toFloat();var e=a.owed().toString();return[{v:c,f:d},{v:b,f:e}]};rc.checkOverflow=function(){var a=rc.$column.width();rc.lastColWidth!==a&&(rc.lastColWidth=a,rc.$chart.css({width:a+"px",height:a+"px"}),rc.drawChart(),rc.largeTableWidth||(rc.largeTableWidth=rc.$table.width()),rc.viewModel.isSmall(rc.largeTableWidth>a))};
