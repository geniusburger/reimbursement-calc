...
e.length+" with owed "+b.toString()+", before: "+a.owed());a.update(b);console.log("updating row "+c+" of "+e.length+" with owed "+b.toString()+", after:  "+a.owed())})});a.deleteAll=function(){a.rows.removeAll();a.rows.push(new RowViewModel(new Date,new Currency("0"),!0,a.isSmall,"Today"))};a.sizeRow=new RowViewModel(new Date(0),new Currency("0"),!0,a.isSmall,"SizeRow");a.rows.push(new RowViewModel(new Date,new Currency("0"),!0,a.isSmall,"Today"))}
