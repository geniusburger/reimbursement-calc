...
StorageManager.prototype.setTimeUnit=function(a){this.set(this.names.TIME_UNIT,a)};StorageManager.prototype.getTimeAmount=function(){return this.get(this.names.TIME_AMOUNT)};StorageManager.prototype.setTimeAmount=function(a){this.set(this.names.TIME_AMOUNT,a)};
StorageManager.prototype.getDates=function(){var a=this.get(this.names.DATES),b=[];null!==a&&""!==a?a.split(":").forEach(function(a){var c=a.split("@");2===c.length?b.push(c):console.warn("invalid saved date value",a)}):console.warn("no cookies found");return b};
