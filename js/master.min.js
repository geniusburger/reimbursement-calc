...
"Mapping From Model");return n(b,e,x)},toModel:function(b){w(this.options,"Mapping To Model");return s(b,x)},updateFromModel:function(b,g,e){e=e?ko.observable(0):void 0;w(this.options,"Update From Model");return t(g,b,x,void 0,e)}}})();var util={removeChildren:function(a){for(;a.firstChild;)a.removeChild(a.firstChild)},getNumberWithCommas:function(a){return a.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")},getSelected:function(a){return document.getElementById(a).selectedOptions[0].value},isInvalidDate:function(a){return isNaN(a.getTime())},toArray:function(a){return Array.prototype.slice.call(a)},stripTime:function(a){if(a instanceof Date)return new Date(a.getTime()-36E5*a.getHours()-6E4*a.getMinutes()-1E3*a.getSeconds()-a.getMilliseconds())}};
function StorageManager(){this.names={DATES:"dates",TIME_AMOUNT:"timeAmount",TIME_UNIT:"timeUnit"};localStorage?(this.set=StorageManager.prototype.setLocalStorage,this.get=StorageManager.prototype.getLocalStorage):!0===navigator.cookieEnabled?(this.set=StorageManager.prototype.setCookie,this.get=StorageManager.prototype.getCookie):this.displayCookieWarning=!0}StorageManager.prototype.getTimeUnit=function(){return this.get(this.names.TIME_UNIT)};
StorageManager.prototype.setTimeUnit=function(a){this.set(this.names.TIME_UNIT,a)};StorageManager.prototype.getTimeAmount=function(){return this.get(this.names.TIME_AMOUNT)};StorageManager.prototype.setTimeAmount=function(a){this.set(this.names.TIME_UNIT,a)};StorageManager.prototype.getDates=function(){var a=this.get(this.names.DATES),b=[];null!==a&&""!==a&&a.split(":").forEach(function(a){var c=a.split("@");2===c.length?b.push(c):console.warn("invalid saved date value",a)});return b};
StorageManager.prototype.setDates=function(a){var b="";"undefined"===typeof a&&(a=dateRowUtil.getStartRows());a.forEach(function(a,c){c&&(b+=":");b+=a.row.amountCell.toString()+"@"+a.row.dateCell.toString()});this.set(this.names.DATES,b)};StorageManager.prototype.getCookie=function(a){a+="=";for(var b=document.cookie.split(";"),d=0;d<b.length;d++){var c=b[d].trim();if(0==c.indexOf(a))return c.substring(a.length,c.length)}return null};
StorageManager.prototype.setCookie=function(a,b){document.cookie=a+"="+b};StorageManager.prototype.setLocalStorage=function(a,b){localStorage.setItem(a,b)};StorageManager.prototype.getLocalStorage=function(a){return localStorage.getItem(a)};
cellUtil={smallSize:!1,setSmallSize:function(a){return cellUtil.smallSize!==a?(console.log("changing small size to "+a),cellUtil.smallSize=a,rowUtil.getCells().forEach(function(a){a.rebuildCell()}),!0):!1}};function Cell(a,b){this.alignmentClass=a;this.options=b?b:{}}Cell.prototype.buildContents=function(){return document.createTextNode("")};Cell.prototype.makeBold=function(a){var b=document.createElement("strong");b.appendChild(a);return b};
Cell.prototype.formatCell=function(){var a=this.buildContents();cellUtil.smallSize&&this.options.smallAlternateText?a=document.createTextNode(this.options.smallAlternateText):this.options.alternateText&&(a=document.createTextNode(this.options.alternateText));if(this.options.hiddenText){var b=document.createElement("div");b.style.position="relative";var c=document.createElement("div");c.appendChild(document.createTextNode(this.options.hiddenText));c.className="hidden-cell";b.appendChild(c);b.appendChild(a);
a=b}this.options.bold&&(a=this.makeBold(a));this.options.invisible&&(b=document.createElement("div"),b.style.visibility="hidden",b.appendChild(a),a=b);return a};Cell.prototype.buildCell=function(){var a=document.createElement("td"),b=document.createElement("div"),c=this.formatCell();b.appendChild(c);this.alignmentClass&&(a.className=this.alignmentClass);a.appendChild(b);this.td=a;this.contentHolder=b;return a};
Cell.prototype.rebuildCell=function(){console.log("before",this.contentHolder);util.removeChildren(this.contentHolder);this.contentHolder.appendChild(this.formatCell());console.log("after",this.contentHolder)};
ButtonCell.prototype=Object.create(Cell.prototype);function ButtonCell(a){Cell.apply(this,[null,a])}ButtonCell.prototype.buildContents=function(){var a=document.createElement("button");a.type="button";a.className="close";a.setAttribute("aria-hidden","true");a.innerHTML="&times;";$(a).click(this.onclick);return a};ButtonCell.prototype.onclick=function(){$(this).closest("tr")[0].row.deleteRow()};
CurrencyCell.prototype=Object.create(Cell.prototype);function CurrencyCell(a,b){Cell.apply(this,["text-right",b]);this.currency=a;"boolean"!==typeof this.options.useThousandsSeparators&&(this.options.useThousandsSeparators=!0);this.currency.useThousandsSeparators=this.options.useThousandsSeparators}CurrencyCell.prototype.update=function(a){this.currency=new Currency(a);this.rebuildCell()};
CurrencyCell.prototype.buildContents=function(){var a=this.currency.toString();cellUtil.smallSize&&(a=a.substring(0,a.lastIndexOf(".")));return document.createTextNode(a)};CurrencyCell.prototype.toString=function(){return this.currency.toString()};
DateCell.prototype=Object.create(Cell.prototype);function DateCell(a,b){Cell.apply(this,["text-right",b]);this.date=a}DateCell.prototype.buildContents=function(){return document.createTextNode(this.toString())};DateCell.prototype.toString=function(){return cellUtil.smallSize?this.date.toLocaleDateString():this.date.toDateString()};
TextCell.prototype=Object.create(Cell.prototype);function TextCell(a,b){Cell.apply(this,["text-center",b]);this.text=a}TextCell.prototype.buildContents=function(){return cellUtil.smallSize&&this.options.smallText?document.createTextNode(this.options.smallText):document.createTextNode(this.text)};
...
rowUtil={table:void 0,getRows:function(){return util.toArray(document.querySelectorAll("#tableBody tr.exists"))},getCells:function(){var a=[];util.toArray(document.querySelectorAll("#tableBody tr")).forEach(function(c){console.log("tr",c,c.row.cells);a=a.concat(c.row.cells)});console.log("all cells",a);return a},updateOwed:function(){for(var a=new Currency("0"),c=rowUtil.getRows(),b=null,d=null,e=0;e<c.length;e++){var f=c[e].row;f.update(a);f instanceof TodayRow&&(b=f);b&&f.isStop()&&(d=util.stripTime(f.dateCell.date),
b=util.stripTime(b.dateCell.date),b=(d-b)/864E5,d=Math.floor(b),d!==b&&(f=Math.ceil(b),b=f-b<b-d?f:d),d={days:b,row:e},b=null)}rc.updateNextExpiration(d)},add:function(a){if(rowUtil.table){var c=rowUtil.getRows(),b=!1,d=a.dateCell.date.getTime();a=a.build();for(var e=0;e<c.length;e++)if(d<c[e].row.dateCell.date.getTime()){rowUtil.table.insertBefore(a,c[e]);b=!0;break}b||rowUtil.table.appendChild(a)}else console.error("rowUtil.table is undefined")}};
function Row(a,c,b,d,e,f){this.className=a;this.dateCell=c;this.amountCell=b;this.owedCell=d;this.typeCell=e;this.cells=[c,e,b,d,f]}Row.prototype.build=function(){var a=document.createElement("tr");a.row=this;a.className=this.className;this.cells.forEach(function(c){a.appendChild(c.buildCell())});return this.tr=a};Row.prototype.update=function(a){};Row.prototype.isStart=function(){return this instanceof DateRow&&this.amountCell.currency.start};
Row.prototype.isStop=function(){return this instanceof DateRow&&!this.amountCell.currency.start};Row.prototype.setSmallSize=function(a){this.cells.forEach(function(c){c.setSmallSize(a)})};
todayRowUtil={TODAY_TEXT:"Today",exists:!1,row:void 0,add:function(){todayRowUtil.exists||(todayRowUtil.row=new TodayRow,rowUtil.add(todayRowUtil.row),rowUtil.updateOwed(),todayRowUtil.exists=!0)}};TodayRow.prototype=Object.create(Row.prototype);function TodayRow(){Row.apply(this,["exists active today-row",new DateCell(new Date,{bold:!0,alternateText:todayRowUtil.TODAY_TEXT}),new TextCell(""),new CurrencyCell(new Currency("0"),{bold:!0}),new TextCell(""),new TextCell("")])}
TodayRow.prototype.update=function(a){this.owedCell.update(a);return a};
dateRowUtil={DATE_START_TEXT:"Reimbursed",DATE_SMALL_START_TEXT:"+",DATE_STOP_TEXT:"Expired",DATE_SMALL_STOP_TEXT:"-",onMouseOver:function(){this.row.highlight(!0,!0);rc.highlightPoints(this.row)},onMouseOut:function(){this.row.highlight(!1,!0);rc.setChartSelection();rc.highlightPoints()},add:function(a,b,d,g,h){var c=new Date(a);b=Number(b);switch(d){case "Days":c.setDate(c.getDate()+b);break;case "Months":c.setMonth(c.getMonth()+b);break;default:console.log("Failed to find time unit, defaulting to years");
case "Years":c.setFullYear(c.getFullYear()+b)}var e=new DateRow(a,g,!0),f=new DateRow(c,new Currency(g),!1);e.pair(f);f.pair(e);rowUtil.add(e);rowUtil.add(f);window.setTimeout(function(){var a=$([e.tr,f.tr]).find("td>div");a.on("transitionend",dateRowUtil.removeAnimationClass);a.addClass("animateIn in");rowUtil.updateOwed();h()},0)},getDateRows:function(){return util.toArray(document.querySelectorAll("#tableBody tr.date-row.exists"))},getStartRows:function(){return util.toArray(document.querySelectorAll("#tableBody tr.date-row.exists.start"))},
removeAll:function(){for(var a=dateRowUtil.getStartRows(),b=0;b<a.length;b++)a[b].row.remove()},deleteAll:function(){for(var a=dateRowUtil.getStartRows(),b=0;b<a.length;b++)a[b].row.remove();rc.storage.setDates()},removeAfterAnimation:function(){$(this).parents("tr").remove()},removeAnimationClass:function(){$(this).removeClass("animateIn")}};DateRow.prototype=Object.create(Row.prototype);
function DateRow(a,b,d){Row.apply(this,["exists date-row "+(d?"start":"stop"),new DateCell(a),new CurrencyCell(b),new CurrencyCell("0"),new TextCell(b.start?dateRowUtil.DATE_START_TEXT:dateRowUtil.DATE_STOP_TEXT,{smallText:b.start?dateRowUtil.DATE_SMALL_START_TEXT:dateRowUtil.DATE_SMALL_STOP_TEXT}),new ButtonCell]);this.matchingRow=void 0;this.amountCell.currency.start=d}DateRow.prototype.pair=function(a){this.matchingRow=a};
...
rowUtil.updateOwed();rc.drawChart()},0)};DateRow.prototype.deleteRow=function(){this.remove();rc.storage.setDates()};DateRow.prototype.highlight=function(a,b){a?$(this.tr).addClass("highlight"):$(this.tr).removeClass("highlight");b&&this.matchingRow.highlight(a,!1)};DateRow.prototype.build=function(){var a=Row.prototype.build.apply(this,[]);a.onmouseover=dateRowUtil.onMouseOver;a.onmouseout=dateRowUtil.onMouseOut;return a};
DateRow.prototype.update=function(a){a.adjust(this.amountCell.currency);this.owedCell.update(a);return a};
sizeRowUtil={sizeRow:null,add:function(){sizeRowUtil.sizeRow||(sizeRowUtil.sizeRow=new SizeRow,rowUtil.add(sizeRowUtil.sizeRow))},getTextCellText:function(){return dateRowUtil.DATE_START_TEXT.length>dateRowUtil.DATE_STOP_TEXT.length?dateRowUtil.DATE_START_TEXT:dateRowUtil.DATE_STOP_TEXT},getTextCellOptions:function(){return{invisible:!0,smallText:dateRowUtil.DATE_SMALL_START_TEXT.length>dateRowUtil.DATE_SMALL_STOP_TEXT.length?dateRowUtil.DATE_SMALL_START_TEXT:dateRowUtil.DATE_SMALL_STOP_TEXT}}};
SizeRow.prototype=Object.create(Row.prototype);function SizeRow(){Row.apply(this,["size-row",new DateCell(new Date(0),{alternateText:"OOO OOO 00 0000",smallAlternateText:"00/00/0000",invisible:!0}),new TextCell("$00,000.00",{invisible:!0,smallText:"$00,000"}),new TextCell("$00,000.00",{invisible:!0,smallText:"$00,000"}),new TextCell(sizeRowUtil.getTextCellText(),sizeRowUtil.getTextCellOptions()),new ButtonCell({invisible:!0})])};

function RowViewModel(c,e,f,g,d){this.owed=ko.observable(new Currency("0"));this.isHighlighted=ko.observable(!1);this.date=c;this.amount=e;this.isStart=f;this.isToday="Today"===d;this.isSizeRow="SizeRow"===d;this.isSmall=g;this.matchingRow=null;this.formattedDate=ko.pureComputed(function(){var a=this.isSmall();return this.sizeRow?a?"00/00/0000":"OOO OOO 00 0000":this.isToday?"Today":a?this.date.toLocaleDateString():this.date.toDateString()},this);this.formattedAmount=ko.pureComputed(function(){var a=
this.amount.toString(),b=this.isSmall();return this.isSizeRow?b?"$00,000":"$00,000.00":this.isToday?"":b?a.substring(0,a.lastIndexOf(".")):a},this);this.formattedOwed=ko.pureComputed(function(){var a=this.owed().toString(),b=this.isSmall();return this.isSizeRow?b?"$00,000":"$00,000.00":b?a.substring(0,a.lastIndexOf(".")):a},this);this.formattedType=ko.pureComputed(function(){var a=this.isSmall();return this.isSizeRow?a?"+":"Reimbursed":this.isToday?"":this.isStart?a?"+":"Reimbursed":a?"-":"Expired"},
this)}RowViewModel.prototype.update=function(c){c.adjust(this.amount);this.owed(new Currency(c))};
function PageViewModel(){var a=this;a.date=ko.observable();a.dateError=ko.observable(!1);a.amount=ko.observable();a.amountError=ko.observable(!1);a.timeAmount=ko.observable(2);a.lastTimeAmount=1;a.timeUnit=ko.observable("Years");a.rows=ko.observableArray();a.isSmall=ko.observable(!1);a.daysLeft=ko.observable(0);a.timeUnitOptions=["Days","Months","Years"];a.sizeRow=new RowViewModel(new Date(0),new Currency("0"),!0,a.isSmall,"SizeRow");a.todayRow=new RowViewModel(new Date,new Currency("0"),!0,a.isSmall,
"Today");a.rows.push(a.todayRow);a.timeAmountOptions=ko.computed(function(){var a=this.timeAmount(),b=0;switch(this.timeUnit()){case "Days":b=30;break;case "Months":b=12;break;case "Years":b=20;break;default:console.error("Failed to populate time amounts from unit: "+this.timeUnit());return}a>b&&(a=b);this.timeAmount(a);for(var a=[],c=1;c<=b;c++)a.push(c);return a},this);a.removePair=function(d){a.rows.remove(d);a.rows.remove(d.matchingRow)};a.rows.subscribe(function(d){var b=new Currency("0");d.forEach(function(a){a.update(b)});
d=a.rows.indexOf(a.todayRow);-1!==d&&d<a.rows().length-1&&a.daysLeft(2)});a.deleteAll=function(){a.rows.remove(function(a){return!a.isToday})};a.getInput=function(){console.log("getInput",this.date(),this.amount(),this.timeAmount(),this.timeUnit());var d=new Date(this.date()),b=new Currency(this.amount()),c=!0;b.valid?a.amountError(!1):(c=!1,a.amountError(!0));util.isInvalidDate(d)?(c=!1,a.dateError(!0)):a.dateError(!1);c&&(this.date(""),this.amount(""),this.addDate(d,b));return!1}}
...
rc.loadDate=function(a,b){a instanceof Array&&2===a.length&&(b=new Currency(a[0]),a=new Date(a[1]));dateRowUtil.add(a,rc.getSelectedTimeAmount(),rc.getSelectedTimeUnit(),b,rc.completeLoadDate)};rc.completeLoadDate=function(){$("#testButton").addClass("hidden");$("#clearButton").removeClass("hidden");rc.drawChart();setTimeout(rc.highlightPoints,1E3)};rc.addDate=function(a,b){rc.loadDate(a,b);rc.storage.setDates()};
rc.loadTestData=function(){[["$7802.05","7/6/2012"],["$6931.49","2/1/2013"],["$7568.49","4/12/2013"],["$3802.00","1/6/2012"],["$3658.51","4/13/2012"],["$775.00","12/21/2012"],["$4350.00","6/28/2013"]].forEach(function(a){rc.addDate(a)})};rc.hoverPointHandler=function(a){rc.lastPoint=a;var b=todayRowUtil.row.tr.rowIndex-2;a.row===b?(rc.setChartSelection([{row:b,column:1}]),rc.colorPoints()):(b=rowUtil.getRows(),b[a.row].row.highlight(!0,!0),rc.highlightPoints(b[a.row].row))};
rc.unhoverPointHandler=function(){for(var a=dateRowUtil.getStartRows(),b=0;b<a.length;b++)a[b].row.highlight(!1,!0);rc.setChartSelection();rc.highlightPoints()};rc.selectPointHandler=function(){rc.hoverPointHandler(rc.lastPoint)};
rc.highlightPoints=function(a){var b=todayRowUtil.row,c=b.tr.rowIndex-2;if("undefined"===typeof a||null===a)rc.setChartSelection([{row:c,column:1}]);else{var d=a.isStart()?a:a.matchingRow,e=d.matchingRow,h=d.tr.rowIndex-2,f=e.tr.rowIndex-2;rc.setChartSelection([{row:h,column:1},{row:f,column:1},{row:c,column:1}])}rc.colorPoints(d,e,b,h,f,c)};
rc.colorPoints=function(a,b,c,d,e,h){rc.TODAY_COLOR||(rc.TODAY_COLOR=$(c.tr).children("td").first().css("backgroundColor"));c=$("svg>g>g>g>circle");for(var f=[],g=0;g<c.length;g++)f.push(c[g].outerHTML);var k=1,m=2,l=3,f=4,g=5;6>c.length?rc.setSelectedPointColor(c[0],c[c.length-1],rc.TODAY_COLOR):(6<c.length&&("none"==c[2].getAttribute("fill")?(k+=3,m+=3,l+=3,f+=3,g+=3):"none"==c[4].getAttribute("fill")?(l+=3,f+=3,g+=3):"none"==c[6].getAttribute("fill")&&(g+=3)),h<d?(e=0,d=m,h=l,m=f,l=g):h<e?(d=0,
h=k,e=m,k=l,m=f,l=g):(d=0,h=k,e=f,k=g),rc.START_COLOR||(rc.START_COLOR=$(a.tr).css("backgroundColor")),rc.STOP_COLOR||(rc.STOP_COLOR=$(b.tr).css("backgroundColor")),rc.setSelectedPointColor(c[d],c[h],rc.START_COLOR),rc.setSelectedPointColor(c[m],c[l],rc.STOP_COLOR),rc.setSelectedPointColor(c[e],c[k],rc.TODAY_COLOR))};rc.setChartSelection=function(a){try{rc.chart.setSelection(a)}catch(b){console.warn("Oddity setting selection",b)}};rc.clearChartSelection=function(){rc.setChartSelection()};
...
null,c=null,d=[["Date","Owed"]],e=0;e<a.length;e++)if(a[e].row instanceof TodayRow)c=a[e].row;else{if(c){var h=a[e].row,f=b.dateCell.date.getTime(),g=c.dateCell.date.getTime(),k=h.dateCell.date.getTime()-f,f=(g-f)/k,b=b.owedCell.currency.toFloat(),h=h.owedCell.currency.toFloat();d.push(rc.buildDot(c,b+f*(h-b)));c=null}b=a[e].row;d.push(rc.buildDot(b))}c&&d.push(rc.buildDot(c));rc.chart.draw(google.visualization.arrayToDataTable(d),rc.CHART_OPTIONS)}else rc.$chart.css("visibility","hidden"),console.error("Chart not ready")};
