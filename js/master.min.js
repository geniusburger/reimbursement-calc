...
function Cell(b,a){this.alignmentClass=b;this.options=a?a:{}}Cell.prototype.buildContents=function(){return document.createTextNode("")};Cell.prototype.makeBold=function(b){var a=document.createElement("strong");a.appendChild(b);return a};
Cell.prototype.formatCell=function(){var b=this.buildContents();this.options.alternateText&&(b=document.createTextNode(this.options.alternateText));if(this.options.hiddenText){var a=document.createElement("div");a.style.position="relative";var c=document.createElement("div");c.appendChild(document.createTextNode(this.options.hiddenText));c.className="hidden-cell";a.appendChild(c);a.appendChild(b);b=a}this.options.bold&&(b=this.makeBold(b));this.options.invisible&&(a=document.createElement("div"),
a.style.visibility="hidden",a.appendChild(b),b=a);return b};Cell.prototype.buildCell=function(){var b=document.createElement("td"),a=document.createElement("div"),c=this.formatCell();a.appendChild(c);this.alignmentClass&&(b.className=this.alignmentClass);b.appendChild(a);this.td=b;this.contentHolder=a;return b};
ButtonCell.prototype=Object.create(Cell.prototype);function ButtonCell(a){Cell.apply(this,[null,a])}ButtonCell.prototype.buildContents=function(){var a=document.createElement("button");a.type="button";a.className="close";a.setAttribute("aria-hidden","true");a.innerHTML="&times;";$(a).click(this.onclick);return a};ButtonCell.prototype.onclick=function(a){$(this).closest("tr")[0].row.deleteRow()};
CurrencyCell.prototype=Object.create(Cell.prototype);function CurrencyCell(a,b){Cell.apply(this,["text-right",b]);this.currency=a;"boolean"!==typeof this.options.useThousandsSeparators&&(this.options.useThousandsSeparators=!0);this.currency.useThousandsSeparators=this.options.useThousandsSeparators}CurrencyCell.prototype.update=function(a){this.currency=new Currency(a);util.removeChildren(this.contentHolder);this.contentHolder.appendChild(this.formatCell())};CurrencyCell.prototype.buildContents=function(){return document.createTextNode(this.currency.toString())};
CurrencyCell.prototype.toString=function(){return this.currency.toString()};
DateCell.prototype=Object.create(Cell.prototype);function DateCell(a,b){Cell.apply(this,["text-right",b]);this.date=a}DateCell.prototype.buildContents=function(){return document.createTextNode(this.toString())};DateCell.prototype.toString=function(){return this.date.toDateString()};
TextCell.prototype=Object.create(Cell.prototype);function TextCell(a,b){Cell.apply(this,["text-center",b]);this.text=a}TextCell.prototype.buildContents=function(){return document.createTextNode(this.text)};
...
rowUtil={table:void 0,getRows:function(){return util.toArray(document.querySelectorAll("#tableBody tr.exists"))},updateOwed:function(){for(var b=new Currency("0"),e=rowUtil.getRows(),a=null,c=null,d=0;d<e.length;d++){var f=e[d].row;f.update(b);f instanceof TodayRow&&(a=f);a&&f.isStop()&&(c=util.stripTime(f.dateCell.date),a=util.stripTime(a.dateCell.date),a=(c-a)/864E5,c=Math.floor(a),c!==a&&(f=Math.ceil(a),a=f-a<a-c?f:c),c={days:a,row:d},a=null)}rc.updateNextExpiration(c)},add:function(b){if(rowUtil.table){var e=
rowUtil.getRows(),a=!1,c=b.dateCell.date.getTime();b=b.build();for(var d=0;d<e.length;d++)if(c<e[d].row.dateCell.date.getTime()){rowUtil.table.insertBefore(b,e[d]);a=!0;break}a||rowUtil.table.appendChild(b)}else console.error("rowUtil.table is undefined")}};function Row(b,e,a,c,d,f){this.className=b;this.dateCell=e;this.amountCell=a;this.owedCell=c;this.typeCell=d;this.cells=[e,d,a,c,f]}
Row.prototype.build=function(){var b=document.createElement("tr");b.row=this;b.className=this.className;this.cells.forEach(function(e){b.appendChild(e.buildCell())});return this.tr=b};Row.prototype.update=function(b){};Row.prototype.isStart=function(){return this instanceof DateRow&&this.amountCell.currency.start};Row.prototype.isStop=function(){return this instanceof DateRow&&!this.amountCell.currency.start};
...
sizeRowUtil={exists:!1,add:function(){sizeRowUtil.exists||(rowUtil.add(new SizeRow),sizeRowUtil.exists=!0)}};SizeRow.prototype=Object.create(Row.prototype);
function SizeRow(){Row.apply(this,["size-row",new DateCell(new Date(0),{alternateText:"OOO OOO 00 0000",invisible:!0}),new TextCell("$00,000.00",{invisible:!0}),new TextCell("$00,000.00",{invisible:!0}),new TextCell(dateRowUtil.DATE_START_TEXT.length>dateRowUtil.DATE_STOP_TEXT.length?dateRowUtil.DATE_START_TEXT:dateRowUtil.DATE_STOP_TEXT,{invisible:!0}),new ButtonCell({invisible:!0})])};
...
window.onload=function(){rc.cookies=new CookieManager;$("#inputButton").on("click",null,rc.getInput);$("#testButton").on("click",null,rc.loadTestData);$("#clearButton").on("click",null,dateRowUtil.deleteAll);$("#inputAmount").keypress(rc.enterCatch);$("#inputDate").keypress(rc.enterCatch);rowUtil.table=document.getElementById("tableBody");sizeRowUtil.add();todayRowUtil.add();rc.populateTimeAmounts("Years",2);var a=$("#timeUnit");if(window.isRunningLocally())rc.loadTestData();else{!0!==navigator.cookieEnabled&&
$("#cookieAlert").removeClass("hidden");var b=rc.cookies.getCookie("timeAmount"),c=rc.cookies.getCookie("timeUnit");null!==b&&null!==c&&""!==b&&""!==c&&(a.val(c),rc.populateTimeAmounts(c,b));rc.cookies.getDates().forEach(function(a){rc.loadDate(a)})}$("#timeAmount").on("change",null,rc.timeAmountChanged);a.on("change",null,rc.timeUnitChanged)};
